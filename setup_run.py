...
input_data = [[0.02,0,0,0],[0.002,0,0,0]]
...
if sim.search == True:
    ...
    # data_search = [[0.2,0.3,1e-3,0,1.,mu_high],
    #   [0.2,0.3,1e-3,0,1.1,mu_high],
    #   [0.2,0.3,1e-3,0,1.2,mu_high],
    #   [0.2,0.3,1e-3,0,1.3,mu_high],
    #   [0.2,0.3,1e-3,0,1.4,mu_high],
    #   [0.2,0.3,1e-3,0,1.5,mu_high],
    #   [0.2,0.3,1e-3,0,1.6,mu_high],
    #   [0.2,0.3,1e-3,0,1.7,mu_high],
    #   [0.2,0.3,1e-3,0,1.8,mu_high],
    #   [0.2,0.3,1e-3,0,1.9,mu_high],
    #   [0.2,0.3,1e-3,0,2.,mu_high],
    #   [0.2,0.3,1e-3,0,2.1,mu_high],
    #   [0.2,0.3,1e-3,0,2.2,mu_high],
    #   [0.2,0.3,1e-3,0,2.3,mu_high],
    #   [0.2,0.3,1e-3,0,2.4,mu_high],
    #   [0.2,0.3,1e-3,0,2.5,mu_high],
    #   [0.2,0.3,1e-3,0,2.6,mu_high],
    #   [0.2,0.3,1e-3,0,1.1,3],
    #   [0.2,0.3,1e-3,0,1.1,3],
    #   [0.2,0.3,1e-3,0,1.2,3],
    #   [0.2,0.3,1e-3,0,1.3,3],
    #   [0.2,0.3,1e-3,0,1.4,3],
    #   [0.2,0.3,1e-3,0,1.5,3],
    #   [0.2,0.3,1e-3,0,1.6,3],
    #   [0.2,0.3,1e-3,0,1.7,3],
    #   [0.2,0.3,1e-3,0,1.8,3],
    #   [0.2,0.3,1e-3,0,1.9,3],
    #   [0.2,0.3,1e-3,0,2.,3],
    #   [0.2,0.3,1e-3,0,2.1,3],
    #   [0.2,0.3,1e-3,0,2.2,3],
    #   [0.2,0.3,1e-3,0,2.3,3],
    #   [0.2,0.3,1e-3,0,2.4,3],
